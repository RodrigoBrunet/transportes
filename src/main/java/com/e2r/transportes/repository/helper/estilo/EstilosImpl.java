...
import com.e2r.transportes.repository.paginacao.PaginacaoUtil;
...
public class EstilosImpl implements EstilosQueries{
	...
	public Page<Estilo> filtrar(EstiloFilter estiloFilter, Pageable pageable) {
		...
		adicionandoFiltro(estiloFilter, criteria);
	...
	private void adicionandoFiltro(EstiloFilter estiloFilter, Criteria criteria) {
